...
class DataIngestion:
    ...
    def get_data_from_gcloud(self)->None:
        try:
            logging.info("entered the get_data_from_gcloud method of data ingestion")
            ...
            logging.info("Exited the get_daata_from_glcoud method of Data ingestion class")

        except Exception as e:
            raise CustomException(e,sys) from e

   
    def unizp_and_clean(self):
         logging.info("entered the unzip_and_clean method of Data ingestion class")

         try:
            with ZipFile(self.data_ingestion_config.ZIP_FILE_PATH,'r') as zip_ref:
                zip_ref.extractall(self.data_ingestion_config.ZIP_FILE_DIR)
            logging.info("Exited the unzip_and_clean method of Data ingestion")

            return self.data_ingestion_config.DATA_ARTIFACTS_DIR,self.data_ingestion_config.DATA_NEW_DATA_ARTIFACTS_DIR
         except Exception as e:
            raise CustomException(e,sys) from e
